...
<div style={{ display: "flex", justifyContent: "center", backgroundColor: "black" }}>
  <Image src="/images/scenario.webp" alt="Scenario" style={{ maxWidth: "600px" }} />
</div>
...
learn how to [integrate your agent](./agent-integration) and dive deeper into the [core concepts](./scenario/concepts).
