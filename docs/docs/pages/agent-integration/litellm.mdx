...
LiteLLM agents work seamlessly with Scenario through the <RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter" }} code={{ python: "AgentAdapter" }} /> interface. LiteLLM provides a unified interface to 100+ LLMs, making it perfect for testing agents across different models.
