...
<RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter", typescript: "agent_adapter.html#scenario.agent_adapter.AgentAdapter" }} code={{ python: "AgentAdapter", typescript: "AgentAdapter" }} />
...
<RefLink link={{ python: "agent_adapter.html#scenario.agent_adapter.AgentAdapter.call", typescript: "agent_adapter.html#scenario.agent_adapter.AgentAdapter.call" }} code={{ python: "call", typescript: "call" }} />
method, which receives an
<RefLink link={{ python: "types.html#scenario.types.AgentInput", typescript: "types.html#scenario.types.AgentInput" }} code={{ python: "AgentInput", typescript: "AgentInput" }} />
and returns
<RefLink link={{ python: "types.html#scenario.types.AgentReturnTypes", typescript: "types.html#scenario.types.AgentReturnTypes" }} code={{ python: "AgentReturnTypes", typescript: "AgentReturnTypes" }} />:
...
<RefLink link={{ python: "index.html#scenario.cache", typescript: "index.html#scenario.cache" }} code={{ python: "@scenario.cache", typescript: "@scenario.cache" }} />
