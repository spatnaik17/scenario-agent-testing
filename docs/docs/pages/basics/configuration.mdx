...
| `SCENARIO_LOG_LEVEL`                      | enum   | `info`                         | Log level: `error`, `warn`, `info`, `debug`.                         | ✅          | ❌      |
...
- Set `SCENARIO_LOG_LEVEL` to one of: `error`, `warn`, `info`, `debug`.
- Example: `SCENARIO_LOG_LEVEL=debug` for verbose output.
- Example: `SCENARIO_LOG_LEVEL=error` to only see errors.
