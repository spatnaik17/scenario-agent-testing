...
<Callout>
	<video src="https://framerusercontent.com/assets/RGmtKb1ursJ7f1KeVRpmOE7IZE.mp4" autoplay controls loop muted playsinline style={{ maxWidth: "100%", borderRadius: "8px", margin: "1em 0" }} />
</Callout>
